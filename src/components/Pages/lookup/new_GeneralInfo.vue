...
export default {
  ...
  computed: {
    ...
    raidProgress() {
      ...
      latestRaid.bosses.forEach(boss => {
      ...
      if (mProgress != 0) {
        return {
          value: `${mProgress}/${latestRaid.bosses.length} M`,
          name: shortRaidName
        };
      } else if (hcProgress != 0) {
        return {
          value: `${hcProgress}/${latestRaid.bosses.length} HC`,
          name: shortRaidName
        };
      } else {
        return {
          value: `${nmProgress}/${latestRaid.bosses.length} NM`,
          name: shortRaidName
        };
      }
      */
